...
app.post('/generate-content', async (req, res) => {
    ...
    try {
        ...
        const openaiPayload = {
            model: "gpt-3.5-turbo", // Consider changing to "gpt-3.5-turbo-1106" or "gpt-4-turbo" for better JSON adherence
            messages: messages,
            temperature: generationConfig?.temperature || 0.7,
            max_tokens: generationConfig?.maxOutputTokens || 2048,
            // *** IMPORTANT: This parameter forces JSON output from OpenAI ***
