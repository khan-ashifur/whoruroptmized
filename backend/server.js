...
app.post('/generate-content', async (req, res) => {
    ...
    try {
        ...
        // Mapping frontend's 'contents' (Gemini-style) to OpenAI's 'messages' format
        ...
        const openaiPayload = {
            ...
            // response_format: { type: "json_object" } // Uncomment if you specifically request JSON object from OpenAI
        };
        ...
        const openaiResponse = await fetch(openaiApiUrl, {
            ...
            headers: {
                ...
                'Authorization': `Bearer ${OPENAI_API_KEY}`, // Authorization header for OpenAI
            },
        ...
        // IMPORTANT FIX: Ensure generatedText is not empty before formatting
        if (!generatedText) {
            console.error('No text was generated by OpenAI:', openaiResult);
            return res.status(500).json({
                error: 'No text was generated by OpenAI',
